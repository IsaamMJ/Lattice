...
SCRIPTS=("lattice" "lattice-close.sh" "lattice-regenerate.sh" "lattice-reopen.sh" "lattice-write-manifest.sh" "migrate.sh" "migrate-status.sh" "migrate-v0.7.sh" "lattice-completion.bash" "lattice-completion.zsh" "prepare-commit-msg.sh" "prepare-commit-msg-lattice.sh" "post-commit-resolve-pending.sh" "lattice-statusline.mjs" "lattice-session-start.mjs" "lattice-stop.mjs" "lattice-grow-telegram.mjs" "lattice-yaml.mjs" "lattice-findings.mjs" "lattice-scan-ignore.mjs" "lattice-secret-scan.mjs" "lattice-timeout-scan.mjs" "lattice-ratelimit-scan.mjs" "lattice-inmem-scan.mjs" "lattice-tenant-scan.mjs" "lattice-resilience-scan.mjs" "pre-commit-audit-core.sh" "lattice-rules-promote.mjs")
