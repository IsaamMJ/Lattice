...
- **v0.8.2** (current) — issue-tracker triage batch. New `lattice install-hooks` (#7), `lattice stats` (#15). Fixed: doctor PATH false-green (#14), `update --self` on project-local installs (#18), did-you-mean hint on schema enum rejections (#19). Tests: 65 → 70.
