...
- **v1.3.1** (current) — `lattice list` hides `tier: OK` markers by default (#16). `--include-ok` / `--all` / `--tier OK` to see them. Matches what SessionStart hook + statusline already do for OK suppression.
